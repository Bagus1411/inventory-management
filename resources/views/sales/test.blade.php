    ...
    <div class="container">
        ...
        <form action="{{ route('sales.store') }}" method="POST" id="form-create">
                        ...
                        <table class="table table-bordered align-middle" id="detail-table">
                            ...
                            <tbody>
                                <tr data-index="0">
                                        ...
                                        <select name="items[0][item_id]" class="form-control 
                                            ...
                                            @foreach ($items as $item)
                                                <option value="{{ $item->id }}"
                                                    @selected(old( 'items[0][item_id]' ) == $item->id )>{{ $item->name }} (Stok:
                                                    {{ $item->stock }})</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <td>
                                        <input type="number" name="items[0][quantity]" placeholder="Qty" value="1"
                                    ...
                                    <td>
                                        <input type="number" readonly name="items[0][discount_amount]" placeholder="Rp"
                                            class="form-control" step="0.01">
                                    </td>
                                    <td>
                                        <input type="text" name="items[0][note]" placeholder="Note" class="form-control">
                                    </td>
                                    <td>
                                        <input type="number" readonly name="items[0][subtotal]" placeholder="Subtotal"
                                            class="form-control" step="0.01">
                                    </td>
                                ...
                                <div class="d-flex gap-2 align-items-center">
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" name="discount_global"
                                            id="discount_global" value="{{ old('discount_global') }}">
                                    </div>
            ...
            <div class="mt-4 d-flex gap-2 mb-4">
                ...
                <a href="{{ route('sales.index') }}" class="btn btn-secondary">Back To Index</a>
            </div>
        </form>
    </div>
@endsection
...
kenapa message error pada customer dan yang lain kecuali invoice number dan date tidak muncul sama sekali